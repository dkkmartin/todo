...
class Cards {
  ...
  static makeCard (object) {
    ...
    const cardTemplate = `<div class="card" data-card="0">
...
class DOM {
  ...
  static updateCardsToScreen () {
    const cardArray = _cards__WEBPACK_IMPORTED_MODULE_0__["default"].showCards()
  }
}
