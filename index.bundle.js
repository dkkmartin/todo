...
_modules_dom__WEBPACK_IMPORTED_MODULE_1__["default"].globalEventListener('click', '.newtodo--accept', e => {
  ...
  const formatedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(date, 'dd/MM/yyyy')
  ...
  _modules_cards__WEBPACK_IMPORTED_MODULE_2__["default"].appendToArray(newCard)
  newTodoForm.reset()
  closeSomethings(overlay, newTodoModal)
})
