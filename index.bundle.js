...
function closeSomethings (thing1, thing2) {
  if (thing1) { _modules_dom__WEBPACK_IMPORTED_MODULE_1__["default"].displayNone(thing1) }
  if (thing2) { _modules_dom__WEBPACK_IMPORTED_MODULE_1__["default"].displayNone(thing2) }
}
...
_modules_dom__WEBPACK_IMPORTED_MODULE_1__["default"].globalEventListener('click', '.newtodo--accept', e => {
  e.preventDefault()
  const inputTitle = _modules_dom__WEBPACK_IMPORTED_MODULE_1__["default"].getElement('#nt__title__input')
  const inputDesc = _modules_dom__WEBPACK_IMPORTED_MODULE_1__["default"].getElement('#nt__description')
  const priority = _modules_dom__WEBPACK_IMPORTED_MODULE_1__["default"].getElement('#priority')
  const project = _modules_dom__WEBPACK_IMPORTED_MODULE_1__["default"].getElement('#project')
  const date = inputDate.value
  const formatedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(date), 'dd/MM/yyyy')
  const newCard = new _modules_cards__WEBPACK_IMPORTED_MODULE_2__["default"](inputTitle.value, inputDesc.value, formatedDate, project.value, priority.value)
...
_modules_dom__WEBPACK_IMPORTED_MODULE_1__["default"].globalEventListener('click', '.fa-edit', () => {
  _modules_dom__WEBPACK_IMPORTED_MODULE_1__["default"].displayBlock(overlay)
  _modules_dom__WEBPACK_IMPORTED_MODULE_1__["default"].displayBlock(editTodoModal)
  defaultDatePicker()
})

_modules_dom__WEBPACK_IMPORTED_MODULE_1__["default"].globalEventListener('click', '.edittodo--accept', () => {
  console.log('hello')
})
